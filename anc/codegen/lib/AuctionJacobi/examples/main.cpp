...
#include "main.h"
#include "AuctionJacobi_terminate.h"
#include "AuctionJacobi_emxAPI.h"
#include "AuctionJacobi_initialize.h"

// Function Declarations
static double argInit_real_T();
static emxArray_real_T *c_argInit_UnboundedxUnbounded_r();
static void main_AuctionJacobi();
...
static void main_AuctionJacobi()
{
  ...
  emxArray_real_T *c;
  emxInitArray_real_T(&assignment, 2);
  emxInitArray_real_T(&prices, 2);

  // Initialize function 'AuctionJacobi' input arguments.
  // Initialize function input argument 'c'.
  c = c_argInit_UnboundedxUnbounded_r();

  // Call the entry-point 'AuctionJacobi'.
  AuctionJacobi(c, assignment, prices);
  emxDestroyArray_real_T(prices);
  emxDestroyArray_real_T(assignment);
